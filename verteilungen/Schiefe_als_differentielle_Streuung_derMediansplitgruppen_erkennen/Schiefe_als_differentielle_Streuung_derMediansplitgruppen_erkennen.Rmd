...
> In welche(n) Schule(n) gilt die Aussage: *Die Streung »der rechten Hälfte der Datenpunkte« (alle Datenpunkte für die gilt $x_i \geq \tilde{x}$) unterscheidet deutlich von der Streuung der andere Hälfte der Datenpunkte*.
