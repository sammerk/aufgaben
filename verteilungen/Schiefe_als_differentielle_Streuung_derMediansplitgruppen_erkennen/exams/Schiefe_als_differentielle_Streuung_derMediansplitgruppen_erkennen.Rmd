...
> In welche(n) Schule(n) gilt die Aussage: *Die Streung »der rechten Hälfte der Datenpunkte« (alle Datenpunkte für die gilt $x_i \geq \tilde{x}$) unterscheidet sich deutlich von der Streuung der anderen Hälfte der Datenpunkte*.
