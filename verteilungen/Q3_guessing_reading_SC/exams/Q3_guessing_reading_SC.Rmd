...
answerlist_mean <- 
  round(descriptives$numeric.p75, 1) * seq(0, 2, .2) %>% 
...
```{r, echo = F, dev='svglite', message=FALSE, warning=FALSE}
...
ex_solution <- 
  answerlist_mean == round(descriptives$numeric.p75, 1)
```
