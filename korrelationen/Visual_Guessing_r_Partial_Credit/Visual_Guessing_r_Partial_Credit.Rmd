Question
========
```{r, echo = F, message = F, warning=FALSE,  fig.width=6, fig.height=6, out.width="400px", dev='svglite', fig.cap=""}
library(tidyverse)
library(hrbrthemes)
library(exams)
...
Obige Abbildung zeigt die Assoziation der beiden Variablen V1 und V2. 

Answerlist
----------
* Wie groß schätzen Sie Pearsons's $r$ für diese Daten? (Verwenden Sie "," als Dezimaltrennzeichen)
...
exsolution: `r num_to_moodle(true_corr, tol = 0.2, breaks = 5, range = partial_credit_range)`