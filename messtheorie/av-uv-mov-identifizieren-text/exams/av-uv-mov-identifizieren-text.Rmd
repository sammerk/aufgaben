  ...
  ggplot(aes(x = x, y = y, xend = xend, yend = yend)) + 
    ...
    geom_dag_label_repel(data = function(x) filter(x, name != "holder"),
                         aes(label = c(substr(variables %>% 
                                       ...
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("IV", "MV", "DV", "IV", "MV")[1]), 
                                              1, 2),
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("DV", "DV", "MV", "MV", "IV")[1]), 
                                              1, 2)))) +
  ...
  ggplot(aes(x = x, y = y, xend = xend, yend = yend)) + 
    ...
    geom_dag_label_repel(data = function(x) filter(x, name != "holder"),
                         aes(label = c(substr(variables %>% 
                                       ...
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("IV", "MV", "DV", "IV", "MV")[2]), 
                                              1, 2),
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("DV", "DV", "MV", "MV", "IV")[2]), 
                                              1, 2)))) +
  ...
  ggplot(aes(x = x, y = y, xend = xend, yend = yend)) + 
    ...
    geom_dag_label_repel(data = function(x) filter(x, name != "holder"),
                         aes(label = c(substr(variables %>% 
                                       ...
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("IV", "MV", "DV", "IV", "MV")[3]), 
                                              1, 2),
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("DV", "DV", "MV", "MV", "IV")[3]), 
                                              1, 2)))) +
  ...
  ggplot(aes(x = x, y = y, xend = xend, yend = yend)) + 
    ...
    geom_dag_label_repel(data = function(x) filter(x, name != "holder"),
                         aes(label = c(substr(variables %>% 
                                       ...
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("IV", "MV", "DV", "IV", "MV")[4]), 
                                              1, 2),
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("DV", "DV", "MV", "MV", "IV")[4]), 
                                              1, 2)))) +
  ...
  ggplot(aes(x = x, y = y, xend = xend, yend = yend)) + 
    ...
    geom_dag_label_repel(data = function(x) filter(x, name != "holder"),
                         aes(label = c(substr(variables %>% 
                                       ...
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("IV", "MV", "DV", "IV", "MV")[5]), 
                                              1, 2),
                                       substr(variables %>% 
                                                slice(topic_manually_set) %>% 
                                                pull(c("DV", "DV", "MV", "MV", "IV")[5]), 
                                              1, 2)))) +
...
```{r, echo = F, fig.width=10, fig.height=7.5, out.width="95%", fig.retina = 2}
if(solution_mode_manually_set == "graphically"){
  final_plot
}
```
...
ex_solution <- c(T,F,F,F,F,F) #DUUUUMY
}
```
